describe 'Widgets: range', ->
  ...
  it 'sets the value of the range when a number is typed', ->
    ...
    txtInput = $('input[type=number]')
    txtInput.val(50)
    # you have to manual trigger this as setting the value programmatically doesn't
  ...
  it 'allows value to be read programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect(widget.range('value')).toBe(40)

  it 'allows value to be set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    txtInput = $('input[type=number]')
  ...
  it 'constrains the value to max when set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
  ...
  it 'constrains the value to min when set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
  ...
  it 'allows the max value to be read programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect(widget.range('max')).toBe(100)

  it 'allows the max value to be set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
  ...
  it 'does not allows the max value to be smaller than min when set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect( () ->
  ...
  it 'allows the min value to be read programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect(widget.range('min')).toBe(0)

  it 'allows the min value to be set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    widget.range('min', 10)
  ...
  it 'does not allows the min value to be greater than max when set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect( () ->
  ...
  it 'allows the step value to be read programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect(widget.range('step')).toBe(10)

  it 'allows the step value to be set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
  ...
  it 'allows the disabled property to be read programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
    expect(widget.range('disable')).toBe(false)

  it 'allows the disabled value to be set programmatically', ->
    input = $('<input id="customRange" type="range" value="40" min="0" max="100" step="10" />')
    $(testNode).append input
    widget = $('#customRange').range()
